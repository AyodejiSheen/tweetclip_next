    ...
    return (
        <>
            ...
            <div className={isDark ? 'dark' : ""}>
                ...
                <section className='flex flex-col lg:flex-row p-5 lg:p-10 h-screen items-start bg-neutral-50 dark:bg-slate-900 gap-y-56 lg:gap-y-0'>
                    <div className=' lg:mt-0 w-full lg:w-1/4 lg:fixed dark:bg-slate-800 bg-neutral-100 rounded-[1.8rem] lg:h-[92%] inset-10 py-8 px-12 order-2 lg:order-1 space-y-14 '>
                        <div>
                    ...
                    <div className='w-full lg:flex-1 lg:ml-[28%]  h-[100%] lg:inset-10 rounded-[3rem] order-1 lg:order-2 space-y-7 '>
                        <div className='flex flex-col lg:flex-row lg:justify-between lg:items-center gap-y-6 lg:gap-y-0'>
                            <div className='flex gap-3 order-2 lg:order-1 justify-center '>
                                <div className='border-2 dark:border-slate-600 dark:text-slate-300 px-7 md:px-10 py-3 flex items-center justify-center rounded-xl space-x-2 text-sm md:text-base '>
                                ...
                                <div className='lg:hidden border-2 dark:border-slate-600 dark:text-slate-300 px-7 md:px-10 py-3 flex items-center justify-center rounded-xl space-x-2 text-sm md:text-base '>
                            ...
                            <div className='flex gap-4 lg:gap-6 order-1 lg:order-2 items-center'>
                                ...
                                {/* dark mode */}
                                <div className='border-2 dark:border-slate-600 dark:text-slate-300 w-10 h-10 lg:h-14 lg:w-14 flex items-center justify-center rounded-xl'>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {/* profile pics */}
                                <div>
                                    <img src={dp} className="w-12 lg:w-14 rounded-xl" alt='img' />
                                </div>
                            </div>
                        </div>

                            <div className='flex justify-center items-center h-screen lg:h-[90%] rounded-2xl bg-slate-300'>
                                <p>This is the Artboard</p>
                            </div>
                    </div>
                </section>
