...
export const Artboard = () => {
    ...
    return (
        <>
            ...
            {
                artboardLoading ?
                    <section className="flex flex-col justify-between p-6 md:p-14 h-max gap-12 md:gap-24 rounded-xl shadow-lg" style={{ backgroundColor: `${artboardProps.bgColor}` }}>
                        {/* top */}
                        <div className="flex justify-between items-center">
                            <div className="flex gap-3 md:gap-5 items-center">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium text-slate-400  text-xs md:text-base lg:text-lg">@{singleArtboard.username}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* main text */}
                        <div >
                            <h1 className="w-11/12 break-words" style={{ fontFamily: ` ${artboardProps.fontStyle}`, fontSize: `${artboardProps.fontSize}px` }} >
                                {singleArtboard.text}
                            </h1>
                        </div>
                        ...
                        <div className="space-y-3">
                            <p className="text-xs md:text-base lg:text-lg text-slate-400">11:40 AM · Nov 16, 2022 · {singleArtboard.source}</p>
