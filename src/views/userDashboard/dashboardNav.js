                        ...
                        <div className='lg:w-4/5 xl:w-2/3'>
                            <div className='flex justify-between items-center'>
                                ...
                                <div className='flex gap-2  md:gap-6  items-center'>
                                    ...
                                    <div>
                                        <img src={dp} className=" cursor-pointer w-10 lg:w-14 rounded-xl" alt='img' onClick={() => showItem('profile')} />
                    ...
                    <div className='w-full lg:flex-1 lg:ml-[28%]  h-[100%] lg:inset-10 rounded-[3rem] order-1 lg:order-2 space-y-7 '>
                        <div className='flex flex-col lg:flex-row lg:justify-between lg:items-center gap-y-6 lg:gap-y-0'>
                            <div className='flex gap-2 order-2 lg:order-1 justify-center '>
                                ...
                                <div onClick={() => showItem('import')} className='cursor-pointer border-2 dark:border-slate-600 dark:text-slate-300 px-6 md:px-10 py-3 flex items-center justify-center rounded-xl space-x-2 text-sm md:text-base '>
                                    <i className="lni lni-cloud-download"></i>
                                    <p>Import</p>
                                </div>

                                <div className='cursor-pointer lg:hidden border-2 dark:border-slate-600 dark:text-slate-300 px-6 md:px-10 py-3 flex items-center justify-center rounded-xl space-x-2 text-sm md:text-base '>
                                    <i className="lni lni-cloud-upload"></i>
                                    <p>Export</p>
                                </div>
                            </div>
