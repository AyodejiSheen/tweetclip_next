        ...
        <>
            ...
            <div className={isDark === 'dark' ? 'dark' : ""}>
                ...
                <section className='bg-neutral-50 dark:bg-slate-900 h-screen'>
                    ...
                    <div className='flex flex-wrap justify-between px-32 fixed w-full h-20 py-3 bg-neutral-50 z-50'>
                        <div className='w-1/3 '>
                            <img src={Logo} className="w-64" alt='tweeclip-logo' />
                        </div>
                            ...
                            <div className='flex flex-col lg:flex-row lg:justify-between lg:items-center gap-y-6 lg:gap-y-0'>
                                ...
                                <div className='flex gap-4 lg:gap-6 order-1 lg:order-2 items-center'>
                                    ...
                                    <div className="flex  items-center flex-1 ">
                                        <div className="relative lg:w-80  focus-within:text-sky-500">
