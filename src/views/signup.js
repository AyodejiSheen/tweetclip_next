      ...
      <section className="h-screen w-screen m-0 flex">
        <div className="m-auto shadow-lg bg-white p-8 rounded-lg space-y-6 w-5/6 md:w-3/5 xl:w-1/3">
          <div className="space-y-3">
            ...
            <div>
              <h2 className="md:text-center font-extrabold text-2xl md:text-3xl">
                Create an account
              </h2>
          ...
          <div className="space-y-4">
            ...
            >
              <Form>
                ...
                <button
                  className="block w-full px-4 py-2.5 shadow-md shadow-purple-300 dark:shadow-gray-900 mt-4 text-sm font-medium text-center text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue"
                  type="submit"
                >
                  Create Account
                </button>
            ...
            <div>
              <a
                href="https://tweetclips-test.herokuapp.com/api/v1/googleoauth"
