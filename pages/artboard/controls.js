    ...
    return (
        <>
            ...
            <div className='space-y-4 py-8'>
                ...
                <div>
                    <div onClick={() => showItem('bgcolor')} className={`cursor-pointer px-6 border-2 text-sm font-medium dark:border-slate-600 flex justify-between dark:text-slate-300 text-center py-5 w-full rounded-lg ${show === "bgcolor" ? "bg-blue-600 border-0 text-white dark:text-white" : ""}`}>
                        <p className="">Background Color</p>
                        <p><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={show === 'bgcolor' ? "rotate-90 transition duration-300" : "transition duration-300"}>
                ...
                <div className="">
                    <button onClick={generateVideo} data-aos="fade-in" data-aos-duration="600"
