        ...
        <>
            ...
            >
                ...
                <div
                    ...
                    <div>
                        <img src='https://res.cloudinary.com/dylrl8ydb/image/upload/v1669032385/pexels-mag-photography-11850842_bxfmxq.jpg' alt="img"
                            style={{
                                width: '120px',
                                height: '120px',
                                borderRadius: '100%'
                ...
                <div >
                    ...
                    >
                        ...
                        {"welecome to this application now".split(' ').map((t) => ` ${t} `).map((t, i) => {
                            return (
                                <span
                                    key={t}
                                    style={{
